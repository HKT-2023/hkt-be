...
export class CancelOfferSuccess {
  @ApiProperty({
    example: NftMessageSuccess.CancelOfferSuccess,
  })
  message: string;
...
export class OfferNotFoundResponse {
  @ApiProperty({
    example: `${NftMessageError.OfferNotFound}`,
  })
  message: string;
}

export class NotOwnerOfferResponse {
  @ApiProperty({
    example: `${NftMessageError.NotOwnerOffer}`,
  })
  message: string;
}
